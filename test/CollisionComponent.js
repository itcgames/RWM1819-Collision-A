...
describe('CollisionManager()', function () {
  ...
  it('Test AABB - Collision', function () {
    var shape1 = new Rectangle(new Vector2(0,0), 0, 2, 2)
    var shape2 = new Rectangle(new Vector2(0,0), 0, 2, 2)
  ...
  it('Test AABB - No Collision', function () {
    var shape1 = new Rectangle(new Vector2(0,0), 0, 2, 2)
    var shape2 = new Rectangle(new Vector2(5,0), 0, 2, 2)

    expect(CollisionManager.AxisAlignedBoundingBox(shape1, shape2)).to.equal(false);
  });

  it('Test CircleCollision - Collision', function () {
    var shape1 = new Circle(new Vector2(0,0), 0, 2)
    var shape2 = new Circle(new Vector2(0,0), 0, 2)
  ...
  it('Test CircleCollision - No Collision', function () {
    var shape1 = new Circle(new Vector2(0,0), 0, 2)
    var shape2 = new Circle(new Vector2(5,0), 0, 2)
  ...
  it('Test SAT - Collision', function () {
    var shape1 = new Rectangle(new Vector2(0,0), 0, 2, 2)
    var shape2 = new Rectangle(new Vector2(1,0), 0, 2, 2)
  ...
  it('Test SAT - No Collision', function () {
    var shape1 = new Rectangle(new Vector2(0,0), 0, 2, 2)
    var shape2 = new Rectangle(new Vector2(3,0), 0, 2, 2)
